...
<head>
    ...
    <title><?php _e( "Register", "wp-afraex" ); ?></title>
                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            <div class="card-header border-0">
                                ...
                                <div class="font-large-1  text-center">
									<?php _e( "Register in Site", "wp-afraex" ); ?>
                                </div>
                            </div>
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="<?php echo add_query_arg( array( 'method' => 'register' ), get_page_link( $post->ID ) ); ?>" method="post">
										<?php wp_nonce_field( 'wp_afraex_register_form', 'wp_afraex_register_form' ); ?>

                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" name="first_name" placeholder="<?php _e( "First Name", "wp-afraex" ); ?>" required>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" name="last_name" placeholder="<?php _e( "Last Name", "wp-afraex" ); ?>" required>
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control round" id="user-password" name="user_pass" placeholder="<?php _e( 'Enter Password', "wp-afraex" ); ?>" pattern=".{8,}" title="<?php _e( "8 characters minimum", "wp-afraex" ); ?>" required>
                                            <div class="form-control-position">
                                                <i class="ft-lock"></i>
                                            </div>
                                        </fieldset>
                                        ...
                                        <div class="form-group text-center">
                                            <button type="submit" class="btn round btn-block btn-glow btn-bg-gradient-x-purple-blue col-12 mr-1 mb-1"><?php _e( 'Register', 'wp-afraex' ); ?></button>
                                        </div>
                                    </form>
                                </div>
